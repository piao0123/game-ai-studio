    ...
    getMapLayout: (width, height) => {
        ...
        return {
            obstacles: [
                ...
                // 4. VIP 贵宾室与观景隔音玻璃墙
                { x: margin + w * 0.42, y: margin + h * 0.32, w: w * 0.23, h: 10, type: 'glass', label: 'OBSERVATION GLASS' },
            ...
            props: [
                ...
                { type: 'desk', x: margin + w * 0.36, y: margin + h * 0.45, w: 36, h: 36, label: 'FLIGHT BOARD' },
